export function ContactSection() {
  return (
    <section className="h-screen flex items-center justify-center bg-white relative px-4">
      <div className="text-center space-y-4 sm:space-y-6 max-w-2xl mx-auto">
        ...
        >
          Reach us at{' '}
          <a
            href="mailto:studio@onebluedot.in"
        ...
        >
          <svg 
            ...
            style={{ color: 'rgb(4, 0, 255)', flexShrink: 0 }}
          >
            <path 
